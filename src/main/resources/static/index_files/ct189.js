...
!a.e&&(e=1);for(p in b)if(!Object.prototype[p])for(m=0;m<f.length;m++)for(e&&(k=b[p].join(","),k==a.account&&(a.e+=("&"!=p.charAt(0)?"&":"")+p,b[p]=[],d=1)),g=0;g<b[p].length;g++)k=b[p][g],k==f[m]&&(e&&(a.e+="&u="+a.escape(k)+("&"!=p.charAt(0)?"&":"")+p+"&u=0"),b[p].splice(g,1),d=1);c||(d=1);if(d){e="";m=2;!c&&a.e&&(e=a.escape(f.join(","))+"="+a.escape(a.e),m=1);for(p in b)!Object.prototype[p]&&0<m&&0<b[p].length&&(e+=(e?"&":"")+a.escape(b[p].join(","))+"="+a.escape(p),m--);a.cookieWrite("s_sq",e)}}}return c};
	...
	b||"transactionID"==b||"state"==b||"zip"==b||"campaign"==b)a[b]=void 0};a.tagContainerMarker="";a.qb=function(c,b){var d,f=a.trackingServer;d="";var e=a.dc,g="sc.",k=a.visitorNamespace;f?a.trackingServerSecure&&a.ssl&&(f=a.trackingServerSecure):(k||(k=a.account,f=k.indexOf(","),0<=f&&(k=k.substring(0,f)),k=k.replace(/[^A-Za-z0-9]/g,"")),d||(d="2o7.net"),e=e?(""+e).toLowerCase():"d1","2o7.net"==d&&("d1"==e?e="112":"d2"==e&&(e="122"),g=""),f=k+"."+e+"."+g+d);d=a.ssl?"https://":"http://";e=a.AudienceManagement&&
		a.AudienceManagement.isReady();d+=f+"/b/ss/"+(a.mobile?"5.":"")+(e?"10":"1")+"/JS-"+a.version+(a.vb?"T":"")+(a.tagContainerMarker?"-"+a.tagContainerMarker:"")+"/"+c+"?AQB=1&rsid="+a.account+"&ndh=1&pf=1&"+(e?"callback=s_c_il["+a._in+"].AudienceManagement.passData&":"")+b+"&AQE=1";a.ab(d);a.da()};a.ab=function(c){a.g||a.kb();a.g.push(c);a.fa=a.r();a.Fa()};a.kb=function(){a.g=a.nb();a.g||(a.g=[])};a.nb=function(){var c,b;if(a.ka()){try{(b=k.localStorage.getItem(a.ia()))&&(c=k.JSON.parse(b))}catch(d){}return c}};
...
s_jt.codeVersion='20190304';
s_jt.usePlugins=true
s_jt.container=document.getElementsByTagName("body")[0];
var clickeFlag = true;
if(window.location!= window.top.location){
	var trkiframeFlag = window.trkIframe;
	if(trkiframeFlag && trkiframeFlag=="true"){
		s_jt.container=window.parent.document.getElementsByTagName("body")[0]
	}else{
		s_jt.t=function(){};
...
s_jt.trackingServer = "webwebfenxi.189.cn:9000";
s_jt.trackingServerSecure = "webwebfenxi.189.cn:9002";
s_jt.t();
...
function trkCitycode(){
	...
	if (typeof window.sfjc =="string" && window.sfjc.trim().length>0){
		s_jt.eVar29 = s_jt.eVar4 = s_jt.server = window.sfjc;
...
if(s_jt.container){
	addEvent(s_jt.container, "click", function(evt){
			...
			if(obj){
				...
				if(clickeFlag){
					...
					for (var i=0;i<3;i++){
						if (btnAttr){
							break;
						}else if (cobj.tagName!=="HTML"&&cobj.parentNode){
							cobj = cobj.parentNode;
							btnAttr = cobj.getAttribute("trkbtn");
						}else return;
					}
					if(btnAttr && btnAttr.indexOf("trkBtnCount") == 0){
						...
						if(btnAttr.indexOf("my189")>0){
							...
							var btnLink = cobj.getAttribute("href");
						}
						s_jt.linkTrackVars="prop42,prop7,prop50";
						s_jt.prop7 = btnLocation;
						s_jt.prop42 = btnName;
						s_jt.prop50 = btnLink;
						s_jt.tl(true, 'o', "BtnClick");
					}else if(cobj.getAttribute("class")=="toptiocs"||(cobj.parentNode && cobj.parentNode.getAttribute("class")=="toptiocs")||(cobj.parentNode &&cobj.parentNode.parentNode&& cobj.parentNode.parentNode.getAttribute("class")=="toptiocs")){
						s_jt.linkTrackVars="prop42,prop7";
						s_jt.prop7 = "topMenu";
						s_jt.prop42 = cobj.text;
						s_jt.tl(true, 'o', "topMenuBtnClick");
					}else if(btnAttr){
						s_jt.prop42 = btnAttr;
						s_jt.prop50 = cobj.getAttribute("href");
						s_jt.linkTrackVars="prop42,prop50";
						s_jt.tl(this, 'o', "BtnClick");
					}
...
var s_obj={};
s_obj.addBtnClickListener=function(evt) {
	try{
		if (evt) {
			var btnAttr = target.getAttribute("trkbtn");
			if(btnAttr && btnAttr.indexOf("trkBtnCount") == 0){
				var btnName = btnAttr.replace(/trkBtnCount_/,"");
				var btnLocation = "";							}
			s_jt.linkTrackVars="prop42,prop7";
...
s_obj.trkBtnClass = ["trkbtn","popbox-link"];
if(s_obj.trkBtnClass && s_obj.trkBtnClass.length>0){
	for(var i=0;i<s_obj.trkBtnClass.length;i++){
		var trkbtns=document.getElementsByClassName(s_obj.trkBtnClass[i]);
		if(trkbtns && trkbtns.length>0){
			for(var i=0;i<trkbtns.length;i++){
				var target = trkbtns[i];
				addEvent(target, "click",s_obj.addBtnClickListener);
			}
		}
	}
}
...
function trkSCUserInfo(){try{if(window.sfjc=='sc'){var scUserCity="";var scUserCityBlock="";var scUserAddress="";var linkMan=document.getElementById('linkMan');var linkManValue=linkMan.value;if(linkManValue!="请输入用户名"&&linkManValue!=""){SCUserInfo.userName=linkManValue;linkMan.onblur=function(){SCUserInfo.userName=linkMan.value}}var linkNo=document.getElementById('linkNo');var linkNoValue=linkNo.value;if(linkNoValue!="请输入联系电话"&&linkNoValue.length>6){SCUserInfo.userPhoneNum=linkNoValue;linkNo.onblur=function(){SCUserInfo.userPhoneNum=linkNo.value}}var cartNo=document.getElementById('cartNo');var cartNoValue1=cartNo.value;if(cartNoValue1!="请输入申办人身份证号码"){SCUserInfo.userId=cartNoValue1;cartNo.onblur=function(){SCUserInfo.userId=cartNo.value}}var scAddress=document.getElementById('address');var addressValue=scAddress.value;if(addressValue!="例如：XX路XX小区XX单元XX号"&&addressValue!=""){SCUserInfo.address=addressValue;scAddress.onblur=function(){SCUserInfo.address=scAddress.value}}}}catch(e){}}
function trkGetFormInfo(){try{var urn=getElementsByAttr("input","trkuserrealname","true");if(urn!=null){for(var i=0;i<urn.length;i++){var tempEle=urn[i];addEvent(tempEle,"blur",function(evt){var bobj=evt.srcElement||evt.target;if(bobj)SCUserInfo.userName=bobj.value})}}var upn=getElementsByAttr("input","trkuserphonenum","true");if(upn!=null){for(var i=0;i<upn.length;i++){var tempEle=upn[i];addEvent(tempEle,"blur",function(evt){var bobj=evt.srcElement||evt.target;if(bobj)SCUserInfo.userPhoneNum=bobj.value})}}var ui=getElementsByAttr("input","trkuseridentity","true");if(ui!=null){for(var i=0;i<ui.length;i++){var tempEle=ui[i];addEvent(tempEle,"blur",function(evt){var bobj=evt.srcElement||evt.target;if(bobj)SCUserInfo.userId=bobj.value})}}var ua=getElementsByAttr("input","trkuseraddress","true");if(ua!=null){for(var i=0;i<ua.length;i++){var tempEle=ua[i];addEvent(tempEle,"blur",function(evt){var bobj=evt.srcElement||evt.target;if(bobj)SCUserInfo.address=bobj.value})}}}catch(e){}}
function trkSendFormInfo(pevName,orderId){try{var pn="sendFormInfo";var oi="";if(pevName&&pevName!="")pn=pevName;if(window.sfjc=='sc'&&orderId&&orderId!=""){oi=orderId;s_jt.prop45=oi}s_jt.prop46=SCUserInfo.userName;s_jt.prop47=SCUserInfo.userPhoneNum;s_jt.prop48=SCUserInfo.userId;s_jt.prop49=SCUserInfo.address;if(oi!=""||s_jt.prop46!=""||s_jt.prop47!=""||s_jt.prop48!=""||s_jt.prop49!=""){s_jt.linkTrackVars="eVar4,prop17,prop41,prop45,prop46,prop47,prop48,prop49";s_jt.tl(true,'o',pn)}}catch(e){console.log(e)}}
...
function $_CN(a){ return  document.getElementsByClassName(a); }

function $_TN(a){ return  document.getElementsByTagName(a); }

function $_N(a){ return  document.getElementsByName(a); }
//  四川宽带绿通
...
if(window.sfjc=='sc'){
	try{
		...
		s_jt.bind(input1,'blur',function(){ sc_kdlt(); });
		s_jt.bind(input2,'blur',function(){ sc_kdlt(); });
		s_jt.bind(input3,'blur',function(){ sc_kdlt(); });
		s_jt.bind(input4,'blur',function(){ sc_kdlt(); });
	}catch(e){}
}


function ifFTTHCheckout(){
	try{
		var j_account ="0";
		var j_account_type ="0";
		var j_Residential_name ="0";
		var j_addr = document.getElementById("J_city").value+"-"+document.getElementById("areaCode").value;
		if(document.getElementsByClassName("curr")[0].innerText=="小区名称"){

			j_Residential_name = document.getElementById("J_name").value;

		}else if(document.getElementsByClassName("curr")[0].innerText=="电信帐号"){

			j_account_type = document.getElementById("J_type").value;
			j_account = document.getElementById("J_num").value;
		}
		s_jt.prop46 = j_Residential_name=="0"?"":j_Residential_name;
		s_jt.prop47 = j_account=="0"?"":j_account;
		s_jt.prop49 =  j_addr;
		s_jt.linkTrackVars="prop46,prop47,prop49";
		s_jt.tl(true, 'o', j_account_type=="0"?"Residential_name":"dx_account");
	}catch(e){}
}

if(window.sfjc=='sc'){
	s_jt.bind(document.getElementById("rNum"),"blur",function(){ifFTTHCheckout(); });
	s_jt.bind(document.getElementById("J_name"),"blur",function(){ifFTTHCheckout(); });
}

function login_monitor(){
	try{
		s_jt.prop46 = document.getElementById("userId").value?document.getElementById("userId").value:"";
		s_jt.linkTrackVars="prop46";
		s_jt.tl(true, 'o',"scPlatformLogin");
	}catch(e){}
}

window.onbeforeunload=function(){
	try{
		s_jt.prop46 = document.getElementById("linkMan").value;
		s_jt.prop47 = document.getElementById("mobile").value;
		s_jt.prop48 = document.getElementById("cardNo").value;
		s_jt.linkTrackVars="prop46,prop47,prop48";
		s_jt.tl(true, 'o', 'kd-lost3');
	}catch(e){}
}
