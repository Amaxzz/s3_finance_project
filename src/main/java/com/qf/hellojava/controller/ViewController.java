...
public class ViewController {
    ...
    public String regView(){return "reg";}
    ...
    public String userView(){ return "add";}
    @RequestMapping("roleview")
    public String roleView(){ return "role";}
    @RequestMapping("permissionview")
    public String permissionView(){ return "permission";}
    ...
    public String auth_advView(){ return "auth_adv";}
    @RequestMapping("auth_certview")
    public String auth_certView(){ return "auth_cert";}
    @RequestMapping("auth_projectview")
    public String auth_projectView(){ return "auth_project";}

    @RequestMapping("accttypeview")
    public String accttypeView(){ return "accttype";}
    @RequestMapping("applyview")
    public String applyView(){ return "apply";}
